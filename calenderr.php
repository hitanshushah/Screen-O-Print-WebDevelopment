...
<head>
<title>Screen-O-Print | Calender Printing</title>
<meta name="description" content="Printing of high quality calendar with custom designs and sizes.">
<meta name="keywords" content="Printing, print, product, service, quaity, calender">
...
<a href="product.html#e"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Calendar</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="calender" src="calender/calender1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="calender" src="calender/calender2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="calender" src="calender/calender3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="calender/calender1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="calender/calender2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="calender/calender3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Sizes Available : <ul ><li>(8" x 5")</li><li>Table Top</li><li>Wall hanging</li><li>Custom Sizes</li></ul></li>
<li>Material Details: <ul><li>Art paper (glossy/matte)</li><li>Sunshine paper</li></ul>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='calender'order by rate desc limit 4 ");
...
<br>
    <br>
     ...
     <a href="penn.php"> <img alt="pen" class="click" src="name/pen.jpg"></a>
      <a href="wiro.php"><img alt="wirobinding" class="click" src="name/wirobinding.jpg"></a>
      <a href="bannerr.php"> <img alt="banner" class="click" src="name/banner.jpg"></a>
  </div>
<div class="foot">
