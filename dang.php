...
<head>
<title>Screen-O-Print | Dangler Printing</title>
<meta name="description" content="Printing from variety of Danglers with high quality in different shapes">
<meta name="keywords" content="Printing, print, product, service, quaity, dangler ">
...
<a href="product.html#f"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Dangler</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="dangler" src="dangler/dangler.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="dangler" src="dangler/dangler2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="dangler" src="dangler/dangler3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="dangler/dangler.jpg" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="dangler/dangler2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="dangler/dangler3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Shapes Available : <ul><li>Oval</li><li>Box</li><li>Custom shape</li></ul></li>
<li>Material Details: <ul><li>Art card (glossy/matte)</li></ul>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='dangler' order by rate desc limit 4 ");
