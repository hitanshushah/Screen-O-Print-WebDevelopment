...
<head>
<title>Screen-O-Print | Sticker, Labels Printing</title>
<meta name="description" content="Get high quality stickers of different sizes and prints">
<meta name="keywords" content="Printing, print, product, service, quaity, stickers, labels">
...
<a href="product.html#q"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Stickers</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="sticker" src="sticker/sticker1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="sticker1" src="sticker/sticker2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="sticker" src="sticker/sticker3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="sticker/sticker1.jpg" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="sticker/sticker2.jpg" onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="sticker/sticker3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Types of stickers Available : <ul ><li>Pharmaceutical plus Roll Form Sticker</li><li>Veterinary</li><li>Custom Types</li></ul></li>
<li>Sticker Quality: <ul><li>Mirror cot</li><li>Cromo</li><li>Transparent and many more...</li></ul>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='sticker' order by rate desc limit 4 ");
...
<br>
     ...
     <a href="card.php"> <img alt="card" class="click" src="name/viisiting.jpg"></a>
      <a href="wiro.php"><img alt="wiro" class="click" src="name/wirobinding.jpg"></a>
