...
<head>
<title>Screen-O-Print | Wedding Cards Printing</title>
<meta name="description" content="Printing from variety of wedding invitations in different languages.">
<meta name="keywords" content="Printing, print, product, service, quaity, wedding card,Invitations, wedding">
...
<a href="product.html#v"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Wedding Invitations</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="wedding" src="wedding/wed1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="wedding" src="wedding/wed2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="wedding" src="wedding/wed3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="wedding/wed1.jpg" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="wedding/wed2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="wedding/wed3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Cards Available : <ul><li>Wedding card</li><li>Invitation Card</li></ul></li>
<li>Languages: <ul><li>English</li><li>Hindi</li><li>Marathi</li><li>Gujarati....and many more</li></ul>
<li>Designing: <ul><li>Designing facilities also Available</li><li>We offer sample album to explore various design</li></li></ul>
<br>
...
<form action="save.php" method="post" class="rating" >
  ...
  <input class="rate" type="text" name="fname" placeholder="enter your name/company name"><br>
    Product Name:<select class="rate" name="pname"> 
                        <option value="weddingcard">Wedding Card</option>
                        </select>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='weddingcard' order by rate desc limit 4 ");
...
<br>
     ...
     <a href="paper.php"> <img alt="paperbag" class="click" src="name/paperbag.jpg"></a>
      <a href="posterr.php"><img alt="paperbag" class="click" src="name/posters.jpg"></a>
