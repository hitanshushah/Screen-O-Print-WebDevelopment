...
<head>
<title>Screen-O-Print | Tags Printing</title>
<meta name="description" content="Attach tags of printing designs and for company purposes at low rates.">
<meta name="keywords" content="Printing, print, product, service, quaity, tags">
...
<a href="product.html#s"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Tags</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="tag" src="tags/tag1.1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="tag" src="tags/tag2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="tag" src="tags/tag3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="tags/tag1.1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="tags/tag2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="tags/tag3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
  <li>Tags Available : <ul><li>Garment tags</li><li>Car tags</li><li>Luggage tags</li></ul></li>
    <li>Sizes Available : <ul ><li>(90mm x 50mm)</li><li>Custom Sizes</li></ul></li>
<li>Material Details: <ul><li>Art card (glossy/matte) (Quality : high)</li><li>Thick brown card (Quality : Standard)</li></ul>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='tags' order by rate desc limit 4 ");
