...
<head>
<title>Screen-O-Print | Mobile Cover Printing</title>
<meta name="description" content="Get customized printing on mobile cover with attractive designs.">
<meta name="keywords" content="Printing, print, product, service, quaity, mobilecover">
...
<a href="product.html#k"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Mobile Cover</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="mobilecover" src="mobilecover/mobilecover1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="mobilecover" src="mobilecover/mobilecover2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="mobilecover" src="mobilecover/mobilecover3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="mobilecover/mobilecover1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="mobilecover/mobilecover2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="mobilecover/mobilecover3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Colours: <ul ><li>Single colour</li><li>Multi colour</li></ul></li>
<li>Covers: <ul><li>Customer can provide cover</li><li>We can provide with mobile covers</li></ul>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='cover' order by rate desc limit 4 ");
...
<br>
     ...
     <a href="penn.php"> <img alt="pen" class="click" src="name/pen.jpg"></a>
      <a href="mugg.php"><img alt="mug" class="click" src="name/mug.jpg"></a>
      <a href="sun.php"> <img alt="sunboard" class="click" src="name/sunboard.jpg"></a> 
  </div>
<div class="foot">
