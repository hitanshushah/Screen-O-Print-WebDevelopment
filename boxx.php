...
<head>
<title>Screen-O-Print | Box Printing</title>
<meta name="description" content="Printing different Sizes of Boxes that can be Printed with folding.">
<meta name="keywords" content="Printing, print, product, service, quaity, box, boxes">
...
<a href="product.html#c"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Boxes</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="boxes" src="boxes/box1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="box" src="boxes/box2.PNG" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img src="boxes/box3.PNG" class="slip" alt="box">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="boxes/box1.jpg" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="boxes/box2.PNG"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="boxes/box3.PNG"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Types of boxes Available : <ul ><li>Pharmaceutical</li><li>Veterinary</li><li>Any many Custom Types</li></ul></li>
<li>Material Details: <ul><li>White back board (Quality : High)</li><li>Mirror Cot board (Quality : Medium)</li><li>Duplex Board  (Quality : Standard) And many more...</li></ul>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='box' order by rate desc limit 4 ");
