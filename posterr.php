...
<head>
<title>Screen-O-Print | Poster Printing</title>
<meta name="description" content="Printing colourful and attractive high quality posters.">
<meta name="keywords" content="Printing, print, product, service, quaity, poster">
...
<a href="product.html#p"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Poster</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="poster" src="poster/poster1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="poster" src="poster/poster2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="poster" src="poster/poster3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="poster/poster1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="poster/poster2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="poster/poster3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Sizes Available : <ul ><li>A4</li><li>A3</li><li>A0</li><li>Custom Sizes</li></ul></li>
<li>Material Details: <ul><li>Art paper (glossy/matte)</li></ul>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='poster' order by rate desc limit 4 ");
...
<br>
     ...
     <a href="card.php"> <img alt="viisiting card" class="click" src="name/viisiting.jpg"></a>
