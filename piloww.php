...
<head>
<title>Screen-O-Print | Pillow Printing</title>
<meta name="description" content="Prints high quality pillow cover with custom designs and sizes.">
<meta name="keywords" content="Printing, print, product, service, quaity, pillow">
...
<a href="product.html#o"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Pillow Cover</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="pillow" src="pillow/pillow1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="pillow" src="pillow/pillow2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="pillow" src="pillow/pillow3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="pillow/pillow1.jpg" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="pillow/pillow2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="pillow/pillow3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
     <li>Printing Available on : <ul><li>All types of pillow covers</li></ul></li>
     <br>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='pillow'order by rate desc limit 4 ");
