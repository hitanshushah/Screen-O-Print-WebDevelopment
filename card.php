...
<head>
<title>Screen-O-Print | Visiting Card Printing</title>
<meta name="description" content="Many printing Designs Available in Various Sizes and High quality material.">
<meta name="keywords" content="Printing, print, product, service, quaity, visiting card">
...
<a href="product.html#u"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Visitng Cards</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="visitingcard" src="visitingcard/visitingcard1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="visitingcard" src="visitingcard/visitingcard2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="visitingcard" src="visitingcard/visitingcaed3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="visitingcard/visitingcard1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="visitingcard/visitingcard2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="visitingcard/visitingcaed3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Card Sizes : <ul><li> 92mm x 54mm </li><li>92mm x 60mm</li><li>Custom sizes</li></ul></li>
<li>Material Details: <ul><li>Texture Card</li><li>Hand made card</li><li>Ivory card</li><li>Non Tearable card</li></ul>
<li>Facilities : <ul><li>Fromt and back printing with spot lamination</li><li>Round corner card</li></ul></li>
<li>Designing: <ul><li>Designing facilities also Available</li></li></ul>
<br>
<li>Available in different size as per your requirement in various quantity </li>
</ul>
<br>
<div class="supper">
...
<i class="fa fa-envelope" > <a href = "mailto:shah_atul2002@yahoo.co.in">  shah_atul2002@yahoo.co.in</a></i><br></div>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='card' order by rate desc limit 4 ");
...
<br>
     ...
     <a href="letter.php"> <img alt="letterhead" class="click" src="name/letter.jpg"></a>
      <a href="tag.php" ><img alt="tags" class="click" src="name/tags.jpg"></a>
      <a href="billbookk.php"> <img alt="billbook" class="click" src="name/billbook.jpg"></a>
  </div>
<div class="foot">
...
<i class="fa fa-home" >  4-Joshi Chawl, Opp. Neeldhara Apt, DevidasLane, S.V.P. Road, Borivali-West, Mumbai-400103</i>
  ...
  <div class="bottom">
    <p>asdfghjkl</p>
    Developed by: <abbr class="bun" title="Mob: 8169800983"><a href="">Hitanshu Shah</a></abbr>
    , Logo Designed by: <abbr class="man" title="Mob: 9969208155"><a href="">Manasvi Gokhlani</a></abbr><br> 
    <p>asdfghjkl</p></div>
  </div>
</div>
