...
<head>
<title>Screen-O-Print | Billbook Printing</title>
<meta name="description" content="Printing of bill books for your buisness at reasonable rates.">
<meta name="keywords" content="Printing, print, product, service, quaity, billbook">
...
<a href="product.html#b"><button class="back" >Back</button></a>
  <div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Bill Book</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="billbook" class="slip" src="billbook/billbook1.jpg">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="billbook" class="slip" src="billbook/billbook2.jpg">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="billbook" class="slip" src="billbook/billbook3.png">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="billbook/billbook1.jpg" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="billbook/billbook2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="billbook/billbook3.png" onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Books Available : <ul ><li>Office book</li><li>Dilivery Challan</li><li>Memo Book and many more.....</li></ul></li>
<li>Sizes Details: <ul><li>A4</li><li>A5</li><li>Custom sizes</li></ul>
<li>We provide quality binding</li>
...
<form action="save.php" method="post" class="rating" >
  ...
  Product Name:<select class="rate" name="pname"> 
                        <option value="billbook">Bill Book</option>
                        </select>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='billbook' order by rate desc limit 4 ");
...
<br>
     ...
     <a href="card.php"> <img alt="visiting card" class="click" src="name/viisiting.jpg"></a>
