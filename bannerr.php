...
<a href="product.html#a"><button class="back" >Back</button></a>
  <div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Banner</i></b></h1>
</div>
<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="slip" class="slip" src="banner/banner1.jpg" >
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="banner" class="slip" src="banner/banner2.jpg" >
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="banner" class="slip" src="banner/banner3.jpg">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="banner/banner1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="banner/banner2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="banner/banner3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<li>Material Details: <ul><li>Star Quality (Quality : High)</li><li>Flex Quality (Quality : Standard)</li></ul>
<li>Designing: <ul><li>Designing facilities also Available</li></li></ul>
<br>
<li>Available in differnt size as per your requirement in various quantity </li>
</ul>
<br>
...
<i class="fa fa-envelope" > <a href = "mailto:shah_atul2002@yahoo.co.in">  shah_atul2002@yahoo.co.in</a></i><br><br></div>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='banner' order by rate desc limit 4 ");
...
<br>
     ...
     <a href="card.html"> <img alt="visiting card" class="click" src="name/viisiting.jpg"></a>
      <a href="posterr.html"><img alt="poster" class="click" src="name/posters.jpg"></a>
      <a href="sun.html"> <img alt="sunboard" class="click" src="name/sunboard.jpg"></a>
  </div>
<hr class="line" style="width: 50%; margin-width:2px; background-color: black"><br>
<div class="foot">
