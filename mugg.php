...
<head>
<title>Screen-O-Print | Mug Printing</title>
<meta name="description" content="Get customized printing on mug and gift to your loved ones.">
<meta name="keywords" content="Printing, print, product, service, quaity, mug">
...
<a href="product.html#l"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Mugs</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="mug" src="mug/mug1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="mug" src="mug/mug2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="mug" src="mug/mug3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="mug/mug1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="mug/mug2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="mug/mug3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Printing Available on : <ul><li>All types of mugs</li></ul></li>
<li>Colour: <ul><li>Single colour</li><li>Multi colour</li></ul>
<br>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='mug' order by rate desc limit 4 ");
