...
<head>
<title>Screen-O-Print | Paperbag Printing</title>
<meta name="description" content="Print custom design on paperbags and also order paperbags in quantity.">
<meta name="keywords" content="Printing, print, product, service, quaity, paperbag">
...
<a href="product.html#m"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Paperbag</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="paperbag" src="paperbag/paperbag1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="paperbag" src="paperbag/paperbag2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="paperbag" src="paperbag/paperbag3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="paperbag/paperbag1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="paperbag/paperbag2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="paperbag/paperbag3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Sizes Available : <ul ><li>(8" x 10")</li><li>(10" x 12")</li><li>Custom Sizes</li></ul></li>
<li>Material Details: <ul><li>Art paper (glossy/matte) (Quality : High)</li><li>Brown Khaki paper (Quality : Standard)</li></ul>
<br>
<li>Available in differnt size as per your requirement in various quality </li>
</ul>
<br>
<div class="supper">
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='paperbag' order by rate desc limit 4 ");
...
<br>
     ...
     <a href="card.php"> <img alt="visitig card" class="click" src="name/viisiting.jpg"></a>
      <a href="posterr.php"><img alt="poster" class="click" src="name/posters.jpg"></a>
      <a href="boxx.php"> <img alt="box" class="click" src="name/boxes.jpg"></a>
  </div>
<div class="foot">
