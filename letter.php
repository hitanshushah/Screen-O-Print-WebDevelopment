...
<head>
<title>Screen-O-Print | Letterhead Printing</title>
<meta name="description" content="Get letterheads printing in large quantity at reasonable rates.">
<meta name="keywords" content="Printing, print, product, service, quaity, letterhead">
...
<a href="product.html#j"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>LetterHead</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="letterhead" src="letterhead/letterhead1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="letterhead" src="letterhead/letterhead2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="letterhead" src="letterhead/letterhead3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="letterhead/letterhead1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="letterhead/letterhead2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="letterhead/letterhead3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Sizes Available : <ul ><li>210mm x 297mm</li><li>Custom Sizes</li></ul></li>
<li>Paper Quality: <ul><li>Alabaster (Quality : High)</li><li>Excel Bond (Quality : Medium)</li><li>Sunshine paper (Quality : Low)</li></ul>
<li>Designing: <ul><li>Designing facilities also Available</li></ul>
<br>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='letterhead' order by rate desc limit 4 ");
...
<h2 style="margin-left: 2% "><b>More Products</b></h2>
     <a href="card.php"> <img alt="viisiting" class="click" src="name/viisiting.jpg"></a>
      <a href="billbookk.php"><img alt="billbookk" class="click" src="name/billbook.jpg"></a>
      <a href="calenderr.php"> <img alt="calender" class="click" src="name/calender.jpg"></a>
  </div>
<div class="foot">
