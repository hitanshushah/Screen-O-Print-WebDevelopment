...
<head>
<title>Screen-O-Print | Pen Printing</title>
<meta name="description" content="Get customized printing on Pens for large quantity ">
<meta name="keywords" content="Printing, print, product, service, quaity, pen">
...
<a href="product.html#n"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Pen Printing</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="pen" src="pen/pen1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="pen" src="pen/pen2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="pen" src="pen/pen3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="pen/pen1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="pen/pen2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="pen/pen3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
     <li>Printing Available on : <ul><li>All types of pens</li></ul></li>
     <br>
<li>Colour: <ul><li>Single colour</li></ul>
<br>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='pen' order by rate desc limit 4 ");
...
<h2 style="margin-left: 2% "><b>More Products</b></h2>
     <a href="calenderr.php"> <img alt="calender" class="click" src="name/calender.jpg"></a>
      ...
      <a href="leaflett.php"> <img alt="leaflet" class="click" src="name/leaflet.jpg"></a>
  </div>
<div class="foot">
