...
<head>
<title>Screen-O-Print | Id Card Printing</title>
<meta name="description" content="Printing id cards of high quality with holders in large quanties">
<meta name="keywords" content="Printing, print, product, service, quaity, id card">
...
<a href="product.html#g"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>ID Cards</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="idcard" src="idcard/id.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="idcard" src="idcard/id2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="idcard" src="idcard/id3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="idcard/id.jpg" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="idcard/id2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="idcard/id3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<li>Material Details: <ul><li>Pancard type (Quality : High)</li><li>Pouch laminated (Quality : Standard)</li></ul>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='id' order by rate desc limit 4 ");
