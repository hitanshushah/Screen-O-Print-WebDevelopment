...
<head>
<title>Screen-O-Print | T-Shirt Printing</title>
<meta name="description" content="Find Amazing Attractive Desigs as well as Printing your Custom Designs.">
<meta name="keywords" content="Printing, print, product, service, quaity, t-shirt">
...
<a href="product.html#t"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>T-Shirt Printing</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="tshirt" src="tshirt/tshirt1.1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="tshirt" src="tshirt/tshirt2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="tshirt" src="tshirt/tshirt3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="tshirt/tshirt1.1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="tshirt/tshirt2.jpg" onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="tshirt/tshirt3.jpg" onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<li>T-Shirt: <ul><li>Customer can provide t-shirt</li><li>We can provide with t-shirt (at extra cost)</li></ul>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='tshirt' order by rate desc limit 4 ");
