...
<script src="code.js"></script>
    ...
    <head>
<title>Screen-O-Print | Wiro, Spiral Binding</title>
<meta name="description" content="Wiro Binding and Spiralbinding can be done at reasonable rates.">
<meta name="keywords" content="Printing, print, product, service, quaity, wiro binding,Spiralbinding, spiral, wiro">
...
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Wiro Binding</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="wirobinding" src="wirobinding/wirobinding1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="wirobinding" src="wirobinding/wirobinding2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="wirobinding" src="wirobinding/wirobinding3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="wirobinding/wirobinding1.jpg" onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="wirobinding/wirobinding2.jpg" onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="wirobinding/wirobinding3.jpg" onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Sizes Available : <ul><li>A4</li><li>A5</li><li>Custom sizes</li></ul></li>

<li>We offer best quality binding</li>
<br>
...
<form action="save.php" method="post" class="rating" >
  ...
  <input class="rate" type="text" name="fname" placeholder="enter your name/company name"><br>
     Product Name:<select class="rate" name="pname"> 
                        <option value="wirobinding">Wiro Binding</option>
                        </select>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='wirobinding' order by rate desc limit 4 ");
...
<br>
     ...
     <a href="billbookk.php"> <img alt="billbookk" class="click" src="name/billbook.jpg"></a>
      <a href="letter.php"><img alt="letter" class="click" src="name/letter.jpg"></a>
      <a href="shirt.php"> <img alt="shirt" class="click" src="name/shirt.jpg"></a>
  </div>
<div class="foot">
