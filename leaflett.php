...
<head>
<title>Screen-O-Print | Leaflet Printing</title>
<meta name="description" content="Get customized leaflets and flyers printing at reasonable rates.">
<meta name="keywords" content="Printing, print, product, service, quaity, leaflet">
...
<a href="product.html#i"><button class="back" >Back</button></a>
<div class="hit">
  <h1 style="text-align:center; color: #4e342e"><b><i>Leaflet</i></b></h1></div>

<div class="container1">
  <div class="mySlides">
    <div class="numbertext">1 / 3</div>
    <img alt="leaflet" src="leaflet/leaflet1.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">2 / 3</div>
    <img alt="leaflet" src="leaflet/leaflet2.jpg" class="slip">
  </div>

  <div class="mySlides">
    <div class="numbertext">3 / 3</div>
    <img alt="leaflet" src="leaflet/leaflet3.jpg" class="slip">
  </div>
...
<br>
  ...
  <div class="row">
    <div class="column">
      <img class="demo cursor" src="leaflet/leaflet1.jpg"  onclick="currentSlide(1)" alt="The Woods">
    </div>
    <div class="column">
      <img class="demo cursor" src="leaflet/leaflet2.jpg"  onclick="currentSlide(2)" alt="Cinque Terre">
    </div>
    <div class="column">
      <img class="demo cursor" src="leaflet/leaflet3.jpg"  onclick="currentSlide(3)" alt="Mountains and fjords">
    </div>
...
<p><b><ul>
    <li>Sizes Available : <ul ><li>A4</li><li>A8</li><li>Custom Sizes</li></ul></li>
<li>Material Details: <ul><li>Art paper (glossy/matte) (Quality : High)</li><li>Normal white paper (Quality : Standard)</li></ul>
...
<div class="col-md-4 ">
  ...
  <div class="row">
    ...
    <?php
    $review = mysqli_query($connection,"SELECT review,rate,fname from stars where pname='leaflet' order by rate desc limit 4 ");
...
<h2 style="margin-left: 2% "><b>More Products</b></h2>
     <a href="mobile.php"> <img alt="cover" class="click" src="name/cover.jpg"></a>
      <a href="posterr.php"><img alt="posterr" class="click" src="name/posters.jpg"></a>
      <a href="booklett.php"> <img alt="booklet" class="click" src="name/booklet.jpg"></a>
  </div>
<div class="foot">
